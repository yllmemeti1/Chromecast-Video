...
var customMessageBus = this.receiverManager_.getCastMessageBus('urn:x-cast:com.nexterp.nlp.licenseurl',cast.receiver.CastMessageBus.MessageType.STRING);
  			customMessageBus.onMessage = function(event) {
     		    licenseURL = event['data'];
            
  }

  var customMessageBus2 = this.receiverManager_.getCastMessageBus('urn:x-cast:com.nexterp.nlp.licensekey',cast.receiver.CastMessageBus.MessageType.STRING);
  			customMessageBus2.onMessage = function(event) {
     		    licensekey = event['data'];
  }
  var customMessageBus3 = this.receiverManager_.getCastMessageBus('urn:x-cast:com.nexterp.nlp.licenseid',cast.receiver.CastMessageBus.MessageType.STRING);
  			customMessageBus3.onMessage = function(event) {
     		    licenseid = event['data'];
  }

  var customMessageBus4 = this.receiverManager_.getCastMessageBus('urn:x-cast:com.nexterp.nlp.Quality');
  			customMessageBus4.onMessage = function(event) {
     		     Quality = event['data'];
  }

  customData={licenseid,licensekey};
  /**
